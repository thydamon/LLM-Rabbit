...
class Doctran:
    def __init__(self, openai_api_key: str = None,
        ...
        if openai_api_key:
            openai_config = OpenAIConfig(api_key=openai_api_key, base_url=openai_base_url)
        elif os.environ.get("OPENAI_API_KEY"):
            openai_config = OpenAIConfig(api_key=os.environ["OPENAI_API_KEY"], base_url=os.environ["OPENAI_API_BASE"])
        else:
